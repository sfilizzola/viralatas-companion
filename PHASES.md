...
**Visual direction (locked):** **A2 · Vest Chronicle** — stage-color top bar, surface cards, chaos meters, denim vest finale with chaotic patch pile (`_temp/wrap-proposals/variant-a2-vest-chronicle.html`).
