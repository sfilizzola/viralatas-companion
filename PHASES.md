...
**No active phased work.** Phases 1–32 are complete. See `FUTURE_IDEAS.md` for the backlog (next rating-related ideas: #8 My Picks display, #9 `/wrap` stats, #10 rating badges).
