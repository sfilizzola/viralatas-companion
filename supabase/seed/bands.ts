...
export const bands: BandSeed[] = [
  ...
  // W.E.T. STAGE — Day 1
  { slot_id: 'WET1', name: 'Seers of Light',       stage: STAGES.WET, start_time: t(D1,11, 0), end_time: t(D1,11,20),  genre: 'Metal Battle',    image_url: PLACEHOLDER },                                                                  
  ...
  { slot_id: 'WET8', name: 'Witchlords',           stage: STAGES.WET, start_time: t(D1,17,30), end_time: t(D1,17,50),  genre: 'Metal Battle',    image_url: PLACEHOLDER },                                                                  
  ...
  { slot_id: 'HBA1', name: 'Gannondorf',           stage: STAGES.HEADBANGERS, start_time: t(D1,11,25), end_time: t(D1,11,45),  genre: 'Metal Battle',                  image_url: PLACEHOLDER },                                                          
  ...
  { slot_id: 'HBA3', name: 'Human Nebula',         stage: STAGES.HEADBANGERS, start_time: t(D1,13, 5), end_time: t(D1,13,25),  genre: 'Metal Battle',   image_url: PLACEHOLDER },
  { slot_id: 'HBA4', name: 'Dead Memories',        stage: STAGES.HEADBANGERS, start_time: t(D1,13,55), end_time: t(D1,14,15),  genre: 'Metal Battle',              image_url: PLACEHOLDER },
  ...
  { slot_id: 'HBA8', name: 'Noiduin',              stage: STAGES.HEADBANGERS, start_time: t(D1,17,55), end_time: t(D1,18,15),  genre: 'Metal Battle',              image_url: PLACEHOLDER },
  { slot_id: 'HBA9', name: 'Invasion',             stage: STAGES.HEADBANGERS, start_time: t(D1,18,45), end_time: t(D1,19, 5),  genre: 'Metal Battle',               image_url: PLACEHOLDER },
  ...
  { slot_id: 'WET15', name: 'Death Row',              stage: STAGES.WET, start_time: t(D2,12,40), end_time: t(D2,13, 0),  genre: 'Metal Battle',       image_url: PLACEHOLDER },
  { slot_id: 'WET16', name: 'Sentient Void',          stage: STAGES.WET, start_time: t(D2,13,30), end_time: t(D2,13,50),  genre: 'Metal Battle',    image_url: PLACEHOLDER },
  ...
  { slot_id: 'WET18', name: 'Rise of the Shadows',    stage: STAGES.WET, start_time: t(D2,15,10), end_time: t(D2,15,30),  genre: 'Metal Battle',          image_url: PLACEHOLDER }, 
  ...
  { slot_id: 'HBA18', name: 'Days of Ruin',           stage: STAGES.HEADBANGERS, start_time: t(D2,15,35), end_time: t(D2,15,55),  genre: 'Metal Battle',     image_url: PLACEHOLDER }, 
