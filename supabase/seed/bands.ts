...
export const bands: BandSeed[] = [
  ...
  { slot_id: 'FAS4', name: 'Hämatom',             stage: STAGES.FASTER, start_time: t(D1,22, 0), end_time: t(D1n, 0, 0), genre: 'Industrial Metal', image_url: `${WOA}/fileadmin/_processed_/5/e/csm_haematom_26_a104ede3d5.jpg` },          

  // LOUDER STAGE — Day 1
  { slot_id: 'LOU1', name: 'Broken By The Scream', stage: STAGES.LOUDER, start_time: t(D1,12, 0), end_time: t(D1,12,45), genre: 'Visual Kei Metal', image_url: `${WOA}/fileadmin/_processed_/6/5/csm_Broken_By_The_Scream-WOA26_8ad83f8245.jpg` }, 
  { slot_id: 'LOU2', name: 'Visions of Atlantis',  stage: STAGES.LOUDER, start_time: t(D1,13,30), end_time: t(D1,14,30), genre: 'Symphonic Metal',  image_url: `${WOA}/fileadmin/_processed_/1/6/csm_visions_of_atlantis_26_2bfe817394.jpg` },     
  { slot_id: 'LOU3', name: 'Thundermother',        stage: STAGES.LOUDER, start_time: t(D1,15,15), end_time: t(D1,16,15), genre: 'Rock',             image_url: `${WOA}/fileadmin/_processed_/9/a/csm_Thundermother-Band-2023_d61771d790.jpg` },     
  { slot_id: 'LOU4', name: 'The Hardkiss',         stage: STAGES.LOUDER, start_time: t(D1,17, 0), end_time: t(D1,18, 0), genre: 'Rock',             image_url: `${WOA}/fileadmin/_processed_/9/8/csm_The_Hardkiss-WOA26_2db7165b54.jpg` },          
  { slot_id: 'LOU5', name: 'The Gathering',        stage: STAGES.LOUDER, start_time: t(D1,18,45), end_time: t(D1,20, 0), genre: 'Gothic Metal',     image_url: `${WOA}/fileadmin/_processed_/0/2/csm_The_Gathering-WOA26_57ded7843d.jpg` },         
  { slot_id: 'LOU6', name: 'Lacuna Coil',          stage: STAGES.LOUDER, start_time: t(D1,21, 0), end_time: t(D1,22,30), genre: 'Gothic Metal',     image_url: `${WOA}/fileadmin/_processed_/6/3/csm_lacuna_coil_26_289f52868d.jpg` },              

  // W.E.T. STAGE — Day 1
  { slot_id: 'WET1', name: MTB,                  stage: STAGES.WET, start_time: t(D1,11, 0), end_time: t(D1,11,20),  genre: 'Metal Battle Hungary',    image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET2', name: 'Speak in Whispers',  stage: STAGES.WET, start_time: t(D1,11,50), end_time: t(D1,12,10),  genre: 'Metal Battle Cyprus',     image_url: `${WOA}/fileadmin/_processed_/9/9/csm_speak_in_whispers_26_157b14e684.jpg` }, 
  { slot_id: 'WET3', name: MTB,                  stage: STAGES.WET, start_time: t(D1,12,40), end_time: t(D1,13, 0),  genre: 'Metal Battle Greece',     image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET4', name: MTB,                  stage: STAGES.WET, start_time: t(D1,13,30), end_time: t(D1,13,50),  genre: 'Metal Battle Sweden',     image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET5', name: MTB,                  stage: STAGES.WET, start_time: t(D1,14,20), end_time: t(D1,14,40),  genre: 'Metal Battle Austria',    image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET6', name: MTB,                  stage: STAGES.WET, start_time: t(D1,15,50), end_time: t(D1,16,10),  genre: 'Metal Battle France',     image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET7', name: MTB,                  stage: STAGES.WET, start_time: t(D1,16,40), end_time: t(D1,17, 0),  genre: 'Metal Battle Luxembourg', image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET8', name: MTB,                  stage: STAGES.WET, start_time: t(D1,17,30), end_time: t(D1,17,50),  genre: 'Metal Battle Belgium',    image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET9', name: MTB,                  stage: STAGES.WET, start_time: t(D1,18,20), end_time: t(D1,18,40),  genre: 'Metal Battle Mexico',     image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET10', name: MTB,                  stage: STAGES.WET, start_time: t(D1,19,10), end_time: t(D1,19,30),  genre: 'Metal Battle Latvia',     image_url: PLACEHOLDER },                                                                  
  { slot_id: 'WET11', name: 'Velvet Rush',        stage: STAGES.WET, start_time: t(D1,20,15), end_time: t(D1,21, 0),  genre: 'AOR',                     image_url: `${WOA}/fileadmin/_processed_/c/c/csm_velvet_rush_26_79ee43e0e7.jpg` },         
  ...
  { slot_id: 'HBA1', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,11,25), end_time: t(D1,11,45),  genre: 'Metal Battle USA',                  image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA2', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,12,15), end_time: t(D1,12,35),  genre: 'Metal Battle Canada',               image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA3', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,13, 5), end_time: t(D1,13,25),  genre: 'Metal Battle Sub Saharan Africa',   image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA4', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,13,55), end_time: t(D1,14,15),  genre: 'Metal Battle Ireland',              image_url: PLACEHOLDER },                                                          
  ...
  { slot_id: 'HBA6', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,16,15), end_time: t(D1,16,35),  genre: 'Metal Battle Lithuania',            image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA7', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,17, 5), end_time: t(D1,17,25),  genre: 'Metal Battle Italy',                image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA8', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,17,55), end_time: t(D1,18,15),  genre: 'Metal Battle Finland',              image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA9', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,18,45), end_time: t(D1,19, 5),  genre: 'Metal Battle Norway',               image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA10', name: MTB,           stage: STAGES.HEADBANGERS, start_time: t(D1,19,35), end_time: t(D1,19,55),  genre: 'Metal Battle Iceland',              image_url: PLACEHOLDER },                                                          
  { slot_id: 'HBA11', name: 'Kadavar',     stage: STAGES.HEADBANGERS, start_time: t(D1,21,15), end_time: t(D1,22,30),  genre: 'Stoner Rock',                       image_url: `${WOA}/fileadmin/_processed_/f/9/csm_kadavar_26b_5241b42bda.jpg` },  
  ...
  { slot_id: 'WAK2', name: 'Alien Rockin Explosion',stage: STAGES.WACKINGER, start_time: t(D1,13,30), end_time: t(D1,14,15), genre: 'Rock',              image_url: `${WOA}/fileadmin/_processed_/a/4/csm_alien_rockin_explosion_26_dba5a44bfe.jpg` }, 
  ...
  { slot_id: 'WAK5', name: 'Vanir',                 stage: STAGES.WACKINGER, start_time: t(D1,18,30), end_time: t(D1,19,30), genre: 'Viking Metal',      image_url: `${WOA}/fileadmin/_processed_/0/f/csm_vanir_26_4989af5ab2.jpg` },                   
  { slot_id: 'WAK6', name: 'Dirty Shirt',           stage: STAGES.WACKINGER, start_time: t(D1,20,15), end_time: t(D1,21,15), genre: 'Crossover Metal',   image_url: `${WOA}/fileadmin/_processed_/8/d/csm_dirty_Shirt_26_d6b1aa60da.jpg` },             
  { slot_id: 'WAK7', name: 'Unzucht',               stage: STAGES.WACKINGER, start_time: t(D1,22,15), end_time: t(D1,23,15), genre: 'Industrial / Gothic', image_url: `${WOA}/fileadmin/_processed_/b/2/csm_unzucht_26_5662cb7925.jpg` },              
  ...
  // HARDER STAGE — Day 2
  { slot_id: 'HAR1', name: 'Uli Jon Roth', stage: STAGES.HARDER, start_time: t(D2,16,15), end_time: t(D2,17,15),  genre: 'Rock',       image_url: `${WOA}/fileadmin/_processed_/3/b/csm_uli_jon_roth26_db0812a7ce.jpg` },     
  ...
  { slot_id: 'FAS6', name: 'Yngwie Malmsteen', stage: STAGES.FASTER, start_time: t(D2,17,30), end_time: t(D2,18,45),  genre: 'Neoclassical Metal',image_url: `${WOA}/fileadmin/_processed_/9/0/csm_yngwie_malmsteen_26_451945c4f5.jpg` }, 
  ...
  // LOUDER STAGE — Day 2
  { slot_id: 'LOU7', name: 'Alien Ant Farm', stage: STAGES.LOUDER, start_time: t(D2,12, 0), end_time: t(D2,13, 0),  genre: 'Alternative Rock', image_url: `${WOA}/fileadmin/_processed_/a/b/csm_alien_ant_farm_26_f4695d8f52.jpg` }, 
  { slot_id: 'LOU8', name: 'H-Blockx',       stage: STAGES.LOUDER, start_time: t(D2,13,45), end_time: t(D2,14,45),  genre: 'Rap Metal',        image_url: `${WOA}/fileadmin/_processed_/c/7/csm_H_Blockx-WOA26_c10c9dda61.jpg` },    
  { slot_id: 'LOU9', name: 'Therapy?',       stage: STAGES.LOUDER, start_time: t(D2,15,30), end_time: t(D2,16,30),  genre: 'Alternative Rock', image_url: `${WOA}/fileadmin/_processed_/8/5/csm_therapy26_acbd2ac94b.jpg` },         
  { slot_id: 'LOU10', name: 'Life of Agony',  stage: STAGES.LOUDER, start_time: t(D2,17,30), end_time: t(D2,18,45),  genre: 'Alternative Metal',image_url: `${WOA}/fileadmin/_processed_/9/4/csm_life_of_agony26_68ef27b061.jpg` },  
  { slot_id: 'LOU11', name: 'P.O.D.',         stage: STAGES.LOUDER, start_time: t(D2,19,45), end_time: t(D2,21, 0),  genre: 'Nu Metal',         image_url: `${WOA}/fileadmin/_processed_/f/0/csm_POD_26_52d8ce1512.jpg` },          
  { slot_id: 'LOU12', name: 'Turbonegro',     stage: STAGES.LOUDER, start_time: t(D2,22, 0), end_time: t(D2,22,30),  genre: 'Punk Rock',        image_url: `${WOA}/fileadmin/_processed_/1/b/csm_turbonegro26_2118d824cd.jpg` },     

  // W.E.T. STAGE — Day 2
  { slot_id: 'WET13', name: MTB,                     stage: STAGES.WET, start_time: t(D2,11, 0), end_time: t(D2,11,20),  genre: 'Metal Battle Balkan Regions', image_url: PLACEHOLDER }, 
  { slot_id: 'WET14', name: MTB,                     stage: STAGES.WET, start_time: t(D2,11,50), end_time: t(D2,12,10),  genre: 'Metal Battle Malta',          image_url: PLACEHOLDER }, 
  { slot_id: 'WET15', name: MTB,                     stage: STAGES.WET, start_time: t(D2,12,40), end_time: t(D2,13, 0),  genre: 'Metal Battle Bulgaria',       image_url: PLACEHOLDER }, 
  { slot_id: 'WET16', name: MTB,                     stage: STAGES.WET, start_time: t(D2,13,30), end_time: t(D2,13,50),  genre: 'Metal Battle Philippines',    image_url: PLACEHOLDER }, 
  { slot_id: 'WET17', name: MTB,                     stage: STAGES.WET, start_time: t(D2,14,20), end_time: t(D2,14,40),  genre: 'Metal Battle Japan',          image_url: PLACEHOLDER }, 
  { slot_id: 'WET18', name: MTB,                     stage: STAGES.WET, start_time: t(D2,15,10), end_time: t(D2,15,30),  genre: 'Metal Battle Spain',          image_url: PLACEHOLDER }, 
  ...
  { slot_id: 'WET21', name: 'Misery Index',          stage: STAGES.WET, start_time: t(D2,20,30), end_time: t(D2,21,30),  genre: 'Death Metal / Grindcore',     image_url: `${WOA}/fileadmin/_processed_/5/a/csm_Misery_Index-WOA26_477d278139.jpg` }, 
  ...
  { slot_id: 'HBA13', name: MTB,                    stage: STAGES.HEADBANGERS, start_time: t(D2,11,25), end_time: t(D2,11,45),  genre: 'Metal Battle Netherlands',     image_url: PLACEHOLDER }, 
  { slot_id: 'HBA14', name: MTB,                    stage: STAGES.HEADBANGERS, start_time: t(D2,12,15), end_time: t(D2,12,35),  genre: 'Metal Battle Czech Republic',  image_url: PLACEHOLDER }, 
  { slot_id: 'HBA15', name: MTB,                    stage: STAGES.HEADBANGERS, start_time: t(D2,13, 5), end_time: t(D2,13,25),  genre: 'Metal Battle Chile',           image_url: PLACEHOLDER }, 
  { slot_id: 'HBA16', name: MTB,                    stage: STAGES.HEADBANGERS, start_time: t(D2,13,55), end_time: t(D2,14,15),  genre: 'Metal Battle India',           image_url: PLACEHOLDER }, 
  { slot_id: 'HBA17', name: MTB,                    stage: STAGES.HEADBANGERS, start_time: t(D2,14,45), end_time: t(D2,15, 5),  genre: 'Metal Battle El Salvador',     image_url: PLACEHOLDER }, 
  { slot_id: 'HBA18', name: MTB,                    stage: STAGES.HEADBANGERS, start_time: t(D2,15,35), end_time: t(D2,15,55),  genre: 'Metal Battle Switzerland',     image_url: PLACEHOLDER }, 
  ...
  { slot_id: 'HBA21', name: 'Anaal Nathrakh',       stage: STAGES.HEADBANGERS, start_time: t(D2,21,45), end_time: t(D2,22,45),  genre: 'Black Metal / Grindcore',      image_url: `${WOA}/fileadmin/_processed_/c/6/csm_AnaalNathrakh1_1706ff6610.jpg` }, 
  ...
  { slot_id: 'WAS12', name: 'Wytch Hazel',         stage: STAGES.WASTELAND, start_time: t(D2,18,30), end_time: t(D2,19,15),  genre: 'Traditional Heavy Metal', image_url: `${WOA}/fileadmin/_processed_/2/5/csm_Wytch_Hazel-WOA26_3a3c5566d4.jpg` }, 
  ...
  { slot_id: 'WAS15', name: 'Year of the Goat',    stage: STAGES.WASTELAND, start_time: t(D2,23, 0), end_time: t(D2n, 0, 0), genre: 'Occult Rock',             image_url: `${WOA}/fileadmin/_processed_/4/e/csm_year_of_the_goat_26_f271ba4dd9.jpg` }, 
  ...
  { slot_id: 'WAK9', name: 'Katerfahrt',   stage: STAGES.WACKINGER, start_time: t(D2,13,30), end_time: t(D2,14,15), genre: 'Rock',       image_url: `${WOA}/fileadmin/_processed_/7/0/csm_Katerfahrt-WOA26_4213c9f3a0.jpg` },   
  ...
  { slot_id: 'HAR8', name: 'Sepultura',    stage: STAGES.HARDER, start_time: t(D3n, 1, 0), end_time: t(D3n, 2,15), genre: 'Groove Metal',   image_url: `${WOA}/fileadmin/_processed_/6/1/csm_Sepultura-WOA26_f6b8328d6d.jpg` },        

  // FASTER STAGE — Day 3
  { slot_id: 'FAS8', name: 'Gutalax',           stage: STAGES.FASTER, start_time: t(D3,12,30), end_time: t(D3,13,30),  genre: 'Goregrind',           image_url: `${WOA}/fileadmin/_processed_/f/4/csm_Gutalax-WOA26_6c3c4625c6.jpg` },        
  { slot_id: 'FAS9', name: 'Paradise Lost',     stage: STAGES.FASTER, start_time: t(D3,14,30), end_time: t(D3,15,30),  genre: 'Gothic Metal',        image_url: `${WOA}/fileadmin/_processed_/8/a/csm_oaradise_lost_26_339356239c.jpg` },     
  ...
  { slot_id: 'FAS11', name: 'In Flames',         stage: STAGES.FASTER, start_time: t(D3,19,45), end_time: t(D3,21,15),  genre: 'Melodic Death Metal', image_url: `${WOA}/fileadmin/_processed_/8/6/csm_In-Flames-WOA26_9e6947d658.jpg` },     
  { slot_id: 'FAS12', name: 'Running Wild',      stage: STAGES.FASTER, start_time: t(D3,23,15), end_time: t(D3n, 0,45), genre: 'Speed Metal',         image_url: `${WOA}/fileadmin/_processed_/b/f/csm_Running_Wild-WOA26_5c9b78de18.jpg` },   

  // LOUDER STAGE — Day 3
  { slot_id: 'LOU13', name: 'Mr. Hurley und die Pulveraffen', stage: STAGES.LOUDER, start_time: t(D3,12, 0), end_time: t(D3,13, 0),  genre: 'Pirate Metal',                  image_url: `${WOA}/fileadmin/_processed_/b/0/csm_mr_hurley_und_die_pulveraffen_26_39b0d12506.jpg` }, 
  ...
  { slot_id: 'LOU18', name: 'Blood Fire Death',               stage: STAGES.LOUDER, start_time: t(D3,20,45), end_time: t(D3,22, 0),  genre: 'Black Metal (Bathory tribute)', image_url: `${WOA}/fileadmin/_processed_/5/d/csm_Blood_Fire_Death-WOA26_c420b03929.jpg` }, 
  ...
  { slot_id: 'LOU20', name: 'Subway to Sally',                stage: STAGES.LOUDER, start_time: t(D3n, 0,45), end_time: t(D3n, 2, 0), genre: 'Medieval Rock',                 image_url: `${WOA}/fileadmin/_processed_/6/3/csm_subway_to_sally_26_c89a7c04fa.jpg` }, 

  // W.E.T. STAGE — Day 3
  { slot_id: 'WET23', name: MTB,                  stage: STAGES.WET, start_time: t(D3,11, 0), end_time: t(D3,11,45),  genre: 'Metal Battle Award Ceremony', image_url: PLACEHOLDER },                                                                  
  ...
  { slot_id: 'WET25', name: 'Deafheaven',         stage: STAGES.WET, start_time: t(D3,15, 0), end_time: t(D3,15,45),  genre: 'Blackgaze',                   image_url: `${WOA}/fileadmin/_processed_/1/0/csm_deafheaven_26_4d801d532f.jpg` },        
  { slot_id: 'WET26', name: 'The Haunted',        stage: STAGES.WET, start_time: t(D3,17, 0), end_time: t(D3,17,45),  genre: 'Melodic Death Metal',         image_url: `${WOA}/fileadmin/_processed_/d/3/csm_The_Haunted-WOA26_849d3b2a7e.jpg` },    
  { slot_id: 'WET27', name: 'Animals as Leaders', stage: STAGES.WET, start_time: t(D3,19, 0), end_time: t(D3,19,45),  genre: 'Progressive Metal',           image_url: `${WOA}/fileadmin/_processed_/2/b/csm_animals_as_leaders26_0a9b3dfbf5.jpg` }, 
  { slot_id: 'WET28', name: 'Crematory',          stage: STAGES.WET, start_time: t(D3,21,15), end_time: t(D3,22,15),  genre: 'Gothic / Industrial Metal',   image_url: `${WOA}/fileadmin/_processed_/7/c/csm_crematory_26_8ae2e22d82.jpg` },         
  { slot_id: 'WET29', name: 'Skynd',              stage: STAGES.WET, start_time: t(D3,23,45), end_time: t(D3n, 0,45), genre: 'Dark Electronic',             image_url: `${WOA}/fileadmin/_processed_/7/3/csm_skynd26_fdaccaa45e.jpg` },              
  ...
  { slot_id: 'HBA26', name: 'Pig Destroyer',    stage: STAGES.HEADBANGERS, start_time: t(D3,18, 0), end_time: t(D3,18,45),  genre: 'Grindcore',              image_url: `${WOA}/fileadmin/_processed_/7/9/csm_Pig_Destroyer-WOA26_111d076650.jpg` },    
  { slot_id: 'HBA27', name: 'Bear McCreary',    stage: STAGES.HEADBANGERS, start_time: t(D3,20, 0), end_time: t(D3,21, 0),  genre: 'Orchestral / Film Music',image_url: `${WOA}/fileadmin/_processed_/a/e/csm_bear_mccreary_26b_802dfd47bf.jpg` },     
  ...
  { slot_id: 'HBA29', name: 'Alcest',           stage: STAGES.HEADBANGERS, start_time: t(D3n, 1, 0), end_time: t(D3n, 2, 0), genre: 'Post-Black Metal',      image_url: `${WOA}/fileadmin/_processed_/d/2/csm_alcest_26_ca67b9d832.jpg` },              
  ...
  { slot_id: 'WAS18', name: 'Chaosbay',                stage: STAGES.WASTELAND, start_time: t(D3,16, 0), end_time: t(D3,16,45),  genre: 'Melodic Death Metal', image_url: `${WOA}/fileadmin/_processed_/c/8/csm_chaos_bay_26_6d40a05540.jpg` },                
  { slot_id: 'WAS19', name: 'Luna Kills',              stage: STAGES.WASTELAND, start_time: t(D3,17,15), end_time: t(D3,18, 0),  genre: 'Symphonic Metal',     image_url: `${WOA}/fileadmin/_processed_/3/3/csm_Luna_Kills-WOA26_9c2715ab09.jpg` },            
  { slot_id: 'WAS20', name: 'Insanity Alert',          stage: STAGES.WASTELAND, start_time: t(D3,18,30), end_time: t(D3,19,15),  genre: 'Crossover Thrash',    image_url: `${WOA}/fileadmin/_processed_/a/3/csm_Insanity_Alert-WOA26_32944b8820.jpg` },        
  ...
  { slot_id: 'WAK16', name: 'Blaas of Glory',  stage: STAGES.WACKINGER, start_time: t(D3,13,15), end_time: t(D3,13,45), genre: 'Folk / Brass Metal',  image_url: `${WOA}/fileadmin/_processed_/e/5/csm_blaas_of_glory_26_f53a31927e.jpg` },         
  { slot_id: 'WAK17', name: 'Metaklapa',       stage: STAGES.WACKINGER, start_time: t(D3,14,15), end_time: t(D3,15, 0), genre: 'Folk',                image_url: `${WOA}/fileadmin/_processed_/8/7/csm_metaklapa_2024_ec19d5fd80.jpg` },            
  ...
  { slot_id: 'WAK20', name: 'Eläkeläiset',     stage: STAGES.WACKINGER, start_time: t(D3,18,45), end_time: t(D3,19,45), genre: 'Humppa',              image_url: `${WOA}/fileadmin/_processed_/e/d/csm_Elaekelaeiset-WOA26_0517340ca3.jpg` },        
  { slot_id: 'WAK21', name: 'Dubioza Kolektiv',stage: STAGES.WACKINGER, start_time: t(D3,20,30), end_time: t(D3,21,30), genre: 'Ska / Reggae Metal',  image_url: `${WOA}/fileadmin/_processed_/e/8/csm_dubioza_kollektiv26_190126a762.jpg` },        
  { slot_id: 'WAK22', name: 'Faun',            stage: STAGES.WACKINGER, start_time: t(D3,22,15), end_time: t(D3,23,15), genre: 'Folk',                image_url: `${WOA}/fileadmin/_processed_/2/4/csm_Faun2-WOA26_dec165b202.jpg` },                 
  ...
  { slot_id: 'HAR10', name: 'Orbit Culture', stage: STAGES.HARDER, start_time: t(D4,13,45), end_time: t(D4,14,45),  genre: 'Melodic Death Metal', image_url: `${WOA}/fileadmin/_processed_/d/c/csm_Orbit_Culture-WOA26_e0ccb2b84a.jpg` }, 
  { slot_id: 'HAR11', name: 'Lamb of God',   stage: STAGES.HARDER, start_time: t(D4,16,15), end_time: t(D4,17,15),  genre: 'Groove Metal',        image_url: `${WOA}/fileadmin/_processed_/7/4/csm_lamb_of_god_26b_d0cd004159.jpg` },    
  { slot_id: 'HAR12', name: 'Arch Enemy',    stage: STAGES.HARDER, start_time: t(D4,19, 0), end_time: t(D4,20,30),  genre: 'Melodic Death Metal', image_url: `${WOA}/fileadmin/_processed_/c/c/csm_arch_enemy_26c_e1e9c04c76.jpg` },     
  ...
  // FASTER STAGE — Day 4
  { slot_id: 'FAS13', name: 'Kim Dracula', stage: STAGES.FASTER, start_time: t(D4,12,30), end_time: t(D4,13,30),  genre: 'Alternative Metal',  image_url: `${WOA}/fileadmin/_processed_/3/4/csm_kim_dracula26_6085add158.jpg` }, 
  { slot_id: 'FAS14', name: 'Nevermore',   stage: STAGES.FASTER, start_time: t(D4,15, 0), end_time: t(D4,16, 0),  genre: 'Progressive Metal',  image_url: `${WOA}/fileadmin/_processed_/6/6/csm_nevermore_26b_55b9630985.jpg` }, 
  ...
  { slot_id: 'LOU23', name: 'Thrown',             stage: STAGES.LOUDER, start_time: t(D4,15,30), end_time: t(D4,16,30),  genre: 'Post-Metal',          image_url: `${WOA}/fileadmin/_processed_/4/9/csm_Thrown-WOA26_f70cc40622.jpg` },           
  ...
  { slot_id: 'LOU25', name: 'Kärbholz',           stage: STAGES.LOUDER, start_time: t(D4,19, 0), end_time: t(D4,20, 0),  genre: 'Folk Punk',           image_url: `${WOA}/fileadmin/_processed_/7/4/csm_kaerbholz_26_85a563b793.jpg` },           
  { slot_id: 'LOU26', name: 'Thy Art Is Murder',  stage: STAGES.LOUDER, start_time: t(D4,20,45), end_time: t(D4,21,45),  genre: 'Deathcore',           image_url: `${WOA}/fileadmin/_processed_/8/0/csm_thy_art_is_murder_26_9e88fcd95e.jpg` },   
  { slot_id: 'LOU27', name: 'Triptykon',          stage: STAGES.LOUDER, start_time: t(D4,22,45), end_time: t(D4n, 0, 0), genre: 'Black / Doom Metal',  image_url: `${WOA}/fileadmin/_processed_/3/c/csm_Triptykon-WOA26_0599ad9698.jpg` },         

  // W.E.T. STAGE — Day 4
  // WET30 — dropped (Name = TBD in lineup.md)
  { slot_id: 'WET31', name: 'Blood Command',          stage: STAGES.WET, start_time: t(D4,13, 0), end_time: t(D4,13,45),  genre: 'Punk Metal',       image_url: `${WOA}/fileadmin/_processed_/e/8/csm_Blood_Command-WOA26_f82b942e22.jpg` },      
  ...
  { slot_id: 'WET33', name: 'Hardline',               stage: STAGES.WET, start_time: t(D4,17, 0), end_time: t(D4,17,45),  genre: 'AOR / Hard Rock',  image_url: `${WOA}/fileadmin/_processed_/c/5/csm_hardline_26_73180980cd.jpg` },                
  { slot_id: 'WET34', name: 'Lagwagon',               stage: STAGES.WET, start_time: t(D4,19, 0), end_time: t(D4,19,45),  genre: 'Melodic Hardcore', image_url: `${WOA}/fileadmin/_processed_/a/e/csm_lagwagon26_9b4cccaa2b.jpg` },                 
  { slot_id: 'WET35', name: 'Corrosion of Conformity',stage: STAGES.WET, start_time: t(D4,21,15), end_time: t(D4,22,15),  genre: 'Sludge Metal',     image_url: `${WOA}/fileadmin/_processed_/0/b/csm_corrosion_of_conformity_26_8ba7dabe09.jpg` }, 
  ...
  { slot_id: 'HBA31', name: 'Crimson Glory',    stage: STAGES.HEADBANGERS, start_time: t(D4,14, 0), end_time: t(D4,14,45),  genre: 'Progressive Metal', image_url: `${WOA}/fileadmin/_processed_/8/2/csm_crimson_glory_26_59c22b790e.jpg` },     
  ...
  { slot_id: 'HBA35', name: 'Vended',           stage: STAGES.HEADBANGERS, start_time: t(D4,22,30), end_time: t(D4,23,30),  genre: 'Nu Metal',          image_url: `${WOA}/fileadmin/_processed_/0/7/csm_vended_26_a96222e9bb.jpg` },             
  ...
  { slot_id: 'WAS28', name: 'The Other',  stage: STAGES.WASTELAND, start_time: t(D4,18,30), end_time: t(D4,19,15),  genre: 'Horror Punk',  image_url: `${WOA}/fileadmin/_processed_/4/8/csm_the_other_26_bb6a90d46d.jpg` },
  ...
  { slot_id: 'WAK27', name: 'Ad Infinitum',           stage: STAGES.WACKINGER, start_time: t(D4,18,30), end_time: t(D4,19,30), genre: 'Symphonic Metal', image_url: `${WOA}/fileadmin/_processed_/f/a/csm_ad_infinitum_26_cb9028b792.jpg` },         
  ...
  { slot_id: 'WAK29', name: 'Einherjer',              stage: STAGES.WACKINGER, start_time: t(D4,22,15), end_time: t(D4,23,15), genre: 'Viking Metal',    image_url: `${WOA}/fileadmin/_processed_/c/2/csm_Einherjer-WOA26_9393fba15b.jpg` },          
